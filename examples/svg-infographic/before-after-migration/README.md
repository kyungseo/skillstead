...
Originally authored synthetic example. Non-client, non-confidential. A generic monolith→microservices illustration, not derived from any engagement artifact.
