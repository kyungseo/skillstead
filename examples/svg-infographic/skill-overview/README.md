...
A one-page infographic that introduces `svg-infographic` itself — what it's for and how it works — made **with the skill**. English and Korean.

| English | 한국어 |
| --- | --- |
| ![svg-infographic overview (EN)](./skill-overview.en.png) | ![svg-infographic 소개 (KO)](./skill-overview.ko.png) |
