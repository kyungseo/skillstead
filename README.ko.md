...
전체 [예제 갤러리](./examples/svg-infographic/README.ko.md)에서 지원 archetype을 다루는 12개 예제 — architecture, migration, workflow, swimlane, 온니언 모델, decision matrix, CI/CD 승격, 승인 흐름 등 — 를 영문·한글 버전과 생성 프롬프트로 확인할 수 있습니다. 위 preview는 대표 6개를 추린 montage입니다.
