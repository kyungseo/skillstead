...
[English](./post-public-verification.md) · **한국어**
...
- [ ] Release tag ruleset이 적용 대상이면 active 상태이거나, 적용 대상이 아니면 not-applicable 근거가
      기록되어 있다.
      (판정 기준: `recurring-release-protection-checkpoint.ko.md`).
- [ ] Branch protection/ruleset을 아직 두지 않는다면 그 이유와 다시 검토할 시점을 accepted risk로 기록했다.
...
타이틀·notes 작성 기준은 `github-public-release-checklist.ko.md` §10을 따른다.
