...
[English](./social-release-note-template.md) · **한국어**
...
주요 대상은 {audience}이며, {job_to_be_done}해야 할 때 유용합니다.
...
영문 채널에 공유할 문구는 [English 문서](social-release-note-template.md)를 사용한다.
