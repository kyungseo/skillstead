...
| [`writing-quality-editor`](./skills/writing-quality-editor) | Composing and revising user-facing text, plus natural English↔Korean adaptation, without inventing or changing facts, intent, voice, or operational constraints | `0.16.0` | Supported: Claude Code + Codex | Beta |
...
document alignment, root changelog, adopted personal-skill synchronization with commit and push, version
announcements, blog follow-up, and optional social drafts.
