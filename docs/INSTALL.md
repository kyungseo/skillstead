...
| `writing-quality-editor` | `writing-quality-editor/v0.17.0` | Claude Code and Codex |
...
- Current release: `writing-quality-editor/v0.17.0`
...
```text
Install this Skillstead skill globally from the pinned GitHub folder: https://github.com/kyungseo/skillstead/tree/writing-quality-editor/v0.17.0/skills/writing-quality-editor
```
