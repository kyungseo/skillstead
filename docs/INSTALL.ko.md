...
| `writing-quality-editor` | `writing-quality-editor/v0.17.0` | Claude Code와 Codex |
...
- 현재 릴리스: `writing-quality-editor/v0.17.0`
...
```text
다음 고정 GitHub 폴더의 Skillstead 스킬을 전역으로 설치해 줘: https://github.com/kyungseo/skillstead/tree/writing-quality-editor/v0.17.0/skills/writing-quality-editor
```
